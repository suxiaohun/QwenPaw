...
@pytest.mark.asyncio
async def test_get_tool_config_reads_credential_and_masks(
...
@pytest.mark.asyncio
async def test_get_tool_config_blank_provider_skips_credential_lookup(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
@pytest.mark.asyncio
async def test_get_tool_config_no_stored_key_omits_api_key(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
@pytest.mark.asyncio
async def test_get_tool_config_provider_query_wins_over_saved_config(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
